...
# ggsave("panel_a.pdf", width = 15, height = 10 , units= "cm")
...
# ggsave("panel_c.pdf", width = 35, height = 12 , units= "cm")
...
ggplot(svg, aes(x = model, y = corr, fill = model, colour = model)) + 
  ...
  mytheme + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + scale_fill_manual( values = c( "#D43F3B" , "#EEA235" ,  "#05A087" , "#4DBBD6",  "#8172B2", "coral" , "steelblue" , "pink3")) +
  scale_colour_manual( values = c( "#D43F3B" , "#EEA235" ,  "#05A087" , "#4DBBD6", "#8172B2", "coral" , "steelblue" , "pink3"))
 


 
# ggsave("panel_b.pdf", width = 20, height = 12 , units= "cm")
